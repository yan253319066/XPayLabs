...
export const metadata: Metadata = {
  title: '技术文档 — 开发者部署指南',
  description:
    '快速将自托管的 XPay Labs 区块链收银网关集群发布至您的服务器之部署教程。涵盖 Docker 编排、环境配置与 API 数据参考说明。',
  alternates: {
              ...
              <div className="space-y-1.5 p-1">
                ...
                <ul className="space-y-1 text-sm font-sans">
                  <li>
                    <a
                      href="#introduction"
                      className="block py-1.5 text-brand-cyan font-semibold border-l-2 border-brand-cyan pl-3"
                    >
                      产品简述
                    </a>
                  </li>
                  <li>
                    <a
                      href="#architecture"
                      className="block py-1.5 text-gray-500 hover:text-white hover:border-l pl-3 transition-all"
                    >
                      非托管物理架构
                    </a>
                  </li>
            ...
            <main className="lg:col-span-9 space-y-10 text-left border-l border-white/5 lg:pl-10">
              ...
              <section id="introduction" className="space-y-4">
                ...
                <p className="text-gray-400 font-sans leading-relaxed text-sm sm:text-base">
                  本部署技术文档将指导您在企业自有或高安全防护的服务器环境中运行
                  XPay Labs 核心收钱网关（支持 VPS 主机、阿里云/腾讯云、AWS
                  实例以及自建 Kubernetes/Docker 容器集群）。通过我们提供的
                  Docker Compose
                  一键整站编排，您可以极速将收钱网关、前端静态收银界面、多链区块索引器及安全消息队列一拉即起，实现
                  100% 绝对自主控权。
                </p>
              </section>
              ...
              >
                ...
                <p className="text-[#9ea4c2] text-sm leading-relaxed font-sans">
                  XPay Labs 网关层完美基于 HD (Hierarchical Deterministic)
                  钱包架构。当系统接收到产生收银 Invoice
                  请求时，网关利用在容器中动态衍生出单次充值公钥。无需向公共云盘备份明文私钥。
                </p>
                <div className="p-4 rounded-xl bg-orange-500/5 border border-orange-500/20 text-xs text-gray-400 space-y-1">
                  ...
                  <div>
                    XPay Labs
                    绝不会将您的助记词、或钱包私钥同步到任何公共远程数据库中。一切密钥运行完全限定在您自营的主机物理沙盒层中。请确保离线保管好备份文件。
                  </div>
                </div>
              </section>
                    ...
                    <tbody className="divide-y divide-white/5 text-gray-300">
                      <tr>
                        ...
                        <td className="p-3 font-sans">
                          高度安全的 BIP-39
                          标准助记词密匙短语，网关依靠其安全派生数以万计不重叠的顾客账单临时付款地址。
                        </td>
                      </tr>
                      <tr>
                        <td className="p-3 font-bold text-brand-cyan">
                        ...
                        <td className="p-3 text-red-400">是</td>
                        <td className="p-3 font-sans">
                          用于对发送给您商户服务器的 Webhook 数据包进行 SHA256
                          HMAC 强加密签名，防止伪造通知。
                        </td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        ...
                        <td className="p-3 text-gray-500">非必须</td>
                        <td className="p-3 font-sans">
                          标准的以太坊或者 L2 系列节点调用 API，用于验证 ERC-20
                          稳定币到账。
                        </td>
                      </tr>
                    </tbody>
